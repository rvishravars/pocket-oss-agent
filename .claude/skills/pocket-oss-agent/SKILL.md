...
description: >-
  ...
  roadmap: given some notion of their skills/resume and a target public GitHub
  repository, produce a one-page plan with a matched "good first issue,"
  validated local setup steps, and a maintainer-friendliness read. Triggers on
  requests like "help me contribute to <repo>", "find me a good first issue in
  <repo>", "give me an OSS contribution roadmap for <repo>". This is the entry
  point that orchestrates the resume-parser, interviewer-agent,
  github-repo-investigator, env-setup-validator, repo-vibe-checker,
  skill-matcher, and contribution-strategy-generator skills in sequence.
---
...
it sequences the other six skills and carries their outputs forward as plain
...
7. **Roadmap** — invoke `contribution-strategy-generator` with all five
